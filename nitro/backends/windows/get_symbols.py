...
def get_offsets(session):
    ...
    offsets['KPROCESS']['ThreadListHead'] = session.profile.get_obj_offset('_KPROCESS',
                                                                           'ThreadListHead')

    offsets['KTHREAD']['ThreadListEntry'] = session.profile.get_obj_offset('_KTHREAD',
                                                                           'ThreadListEntry')

    offsets['KTHREAD']['State'] = session.profile.get_obj_offset('_KTHREAD', 'State')

    offsets['KTHREAD']['ContextSwitches'] = session.profile.get_obj_offset('_KTHREAD', 'ContextSwitches')

    offsets['KTHREAD']['KernelStack'] = session.profile.get_obj_offset('_KTHREAD', 'KernelStack')

    offsets['ETHREAD']['Cid'] = session.profile.get_obj_offset('_ETHREAD', 'Cid')
    ...
    offsets['CLIENT_ID']['UniqueThread'] = session.profile.get_obj_offset('_CLIENT_ID', 'UniqueThread')
